...
weights_and_percent_multiplot <- ggarrange(weights_barplot_all_spp, weights_barplot_gv, boxplots_for_multiplot, ncol = 1, nrow = 3, heights = c(1, 1, 1), labels = c("(a)", "(b)", "(c)"), font.label = list(size = label_size, face = "bold"))
