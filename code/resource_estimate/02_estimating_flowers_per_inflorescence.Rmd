...
flowers_per_inflorescence <- flowers_per_inflor_data_no_duplicates %>%
  ...
  mutate(source = factor(source, levels = c('Birkett inflorescence counts (2014)', 'Notes from resource counts (2016-2018)', 'Nectar sampling (2018)', 'Focal plant flower counts (2017-2018)', 'Estimated by experienced observer'))) %>%
