...
species_list <- resource_data %>%
  distinct(family, species_name, species_code, species_code_for_calories) %>%
  mutate(known_vs_unknown = ifelse(grepl("UNKN", species_code), "unknown", "known")) %>%
...
resource_data_filtered <- resource_data %>%
  filter(!grepl("UNKN", species_code_for_calories)) %>%  #Remove unknown species that did not have an approximate (i.e., genus level) species substituted
...
write.csv(proportion_calories_removed_tailored_supp, "../../data/export/supp_tables/Proportion_calories_removed.csv")
write.csv(proportion_calories_removed_tailored_sum, "../../data/export/supp_tables/Proportion_calories_removed_sum.csv")
write.csv(heto_densities, "../../data/export/supp_tables/Heliconia_densities.csv")
write.csv(heto_densities_sum, "../../data/export/supp_tables/Heliconia_densities_sum.csv")
