...
percentage_calories_removed_tailored_supp <- percentage_calories_removed_tailored %>%
  ...
  filter(count_estimate_high_low == "high") %>% #i.e., assuming unknown count unit of inflorescences vs. flower
...
write.csv(percentage_calories_removed_tailored_supp, "../../data/export/supp_tables/Percentage_calories_removed.csv", row.names = FALSE)
write.csv(percentage_calories_removed_tailored_sum, "../../data/export/supp_tables/Percentage_calories_removed_sum.csv", row.names = FALSE)
