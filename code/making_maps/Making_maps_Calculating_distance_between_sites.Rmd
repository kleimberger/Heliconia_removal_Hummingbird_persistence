...
path_name <- c("data/export/spatial_layers")
...
```{r}
forest = raster::raster("data/export/spatial_layers/Leimberger_GE_forest_layer_UTM.tif") 
chase_forest = raster::raster("data/export/spatial_layers/Mendenhall_GE_forest_layer_UTM.tif")
```
