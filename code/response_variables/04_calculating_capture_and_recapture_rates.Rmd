...
Will need to decide whether or not to include sites that didn't have any captures during 'pre'. Including would be biased *against* finding a treatment effect (decline in capture numbers), since you can only go up from zero.
...
#CAPTURES
#For main analysis
write.csv(capture_rates, "../../data/export/for_analysis/Capture_rates.csv")
