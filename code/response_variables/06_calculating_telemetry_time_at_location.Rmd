...
check04 <- time_at_loc_data %>%
  ...
  select(year, observer, patch, species, frequency, date, starts_with("time"), point_in_patch, notes_location_english, notes_location_spanish, notes_data)
...
```{r, export_data}
write.csv(telem_data03, "../../data/export/intermediate/Telemetry_data_2016-2018_time_at_location.csv")

ggsave("../../results/response_variables/figures/Time_at_location_density_plots.png", plot = time_at_loc_plots, width = 10, height = 7.5, units = "in", dpi = 300)
```
