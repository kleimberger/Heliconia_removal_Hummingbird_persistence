...
emmeans_cameras <- results_categorical %>%
  ...
  filter(plant_species != "RABO") %>% #RABO model was weird, fit better with hours as covariate instead of offset
...
```{r}
#MAIN PLOT: Captures, Telemetry, Cameras (HETO and non-HETO)
