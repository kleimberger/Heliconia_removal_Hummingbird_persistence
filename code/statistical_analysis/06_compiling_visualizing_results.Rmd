...
contrast_multiplot_captures_telemetry <- ggarrange(contrast_plot_captures, contrast_plot_telemetry, common.legend = TRUE, ncol = 2, nrow = 1, align = "hv", legend = "bottom", widths = c(1, 1), labels = c("A", "B"), font.label = list(size = 22, face = "bold"))
...
contrast_multiplot_cameras_poll_upper <- ggarrange(contrast_plot_flower_visits, contrast_plot_pollination, ncol = 2, nrow = 1, align = "hv", legend = "none", widths = c(1, 1), labels = c("A", "B"), font.label = list(size = 22, face = "bold"))

contrast_multiplot_cameras_poll_upper

contrast_multiplot_cameras_poll_lower <- ggarrange(contrast_plot_nonheto, labels = c("C"), font.label = list(size = 22, face = "bold"))
...
contrast_multiplot_addl_analyses <- ggarrange(contrast_plot_recaps, contrast_plot_marked, contrast_plot_body_mass,
                                              common.legend = TRUE, ncol = 1, nrow = 3, align = "hv", legend = "bottom", labels = c("A", "B", "C"), font.label = list(size = 22, face = "bold"))
