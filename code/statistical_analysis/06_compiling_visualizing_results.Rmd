...
camera_heto_marked_label <- c(expression(atop(bold("Flower visitation"), atop(textstyle("focal"~italic(Heliconia)), atop(scriptscriptstyle(""), atop(textstyle("visits/hr"), atop(scriptscriptstyle(""), textstyle("(marked birds)"))))))))
camera_nonheto_marked_label <- c(expression(atop(bold("Flower visitation"), atop(textstyle("non-"*italic(Heliconia)), atop(scriptscriptstyle(""), atop(textstyle("visits/hr"), atop(scriptscriptstyle(""), textstyle("(marked birds)"))))))))
